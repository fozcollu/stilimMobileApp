...
import MainHeader from '../baseComponents/MainHeader';
...
class Camera extends Component {
  ...
  render() {
    ...
    let mainViewStyle = {
      ...
      height:
        orientation.height -
        style.footerHeight * isPortrait -
        orientation.minusHeight -
        orientation.insetBottom,
    };
    ...
    return (
      <Container fullBlack>
                ...
                <React.Fragment>
                  {cameraCount > 2 ? (
                    <View style={styles.cameraSelectionRow}>
                      <Button transparent onPress={this.changeWB} selfCenter>
                  ...
                  <View style={styles.buttonsView}>
                    <Button transparent onPress={this.resetZoom} selfCenter>
                    ...
                    <Button transparent onPress={this.toggleFlash} selfCenter>
        ...
        {isPortrait ? (
          ...
          <Footer landscape>
            <FooterTab landscape>{buttons}</FooterTab>
          </Footer>
        )}
      </Container>
    );
