...
const IPHONE_INSET_TOP_LANDSCAPE =
  conf.theme.variables.Inset.landscape.topInset;

const IPHONE_INSET_BOTTOM = conf.theme.variables.Inset.portrait.bottomInset;
const IPHONE_INSET_BOTTOM_LANDSCAPE =
  conf.theme.variables.Inset.landscape.bottomInset;
